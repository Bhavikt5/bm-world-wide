...
class WPR_Templates_Data {
	...
	public static function get_available_kits_for_pages() {
		...
		return [
			...
			'construction-v3' => [
				'name' => 'Construction v3',
				'pages' => ['home','home-v2','shop','about','services','gallery','blog','contact'],
				'preview' => ['home','home-v2','shop','about','services','gallery','blog','contact'],
				'price' => $is_pro_active ? 'free' : 'pro',
			],
			'home-care-v1' => [
				'name' => 'Home Care',
			...
			'personal-blog-v3' => [
				...
				'pages' => ['home','blog-v1','blog-v2','blog-v3','about','contact'],
				'preview' => ['home','blog-v1','blog-v2','blog-v3','about','contact'],
				'price' => $is_pro_active ? 'free' : 'free',
			],
		];
	}
